...
import com.comrade.domain.dto.create.OrderItem;
...
import com.comrade.domain.ports.input.service.OrderApplicationService;
...
public class OrderApplicationServiceTest {
    ...
    public void testCreateOrderWithWrongProductPrice() {
        ...
        assertEquals("Order item price: 60.00 is not valid for the product: " + PRODUCT_ID, orderDomainException.getMessage());
    }
}
