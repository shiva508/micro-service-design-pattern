package com.comrade.messaging.mapper;
...
import com.comrade.kafka.order.avro.model.*;
...
public class OrderMessagingDataMapper {
    ...
    orderPaidEventToRestaurantApprovalRequestAvroModel(OrderPaidEvent orderPaidEvent) {
        ...
        return RestaurantApprovalRequestAvroModel.newBuilder()
                ...
                .setOrderId(order.getId().getValue().toString())
                .setRestaurantOrderStatus(com.comrade.kafka.order.avro.model.RestaurantOrderStatus
                        .valueOf(order.getOrderStatus().name()))
                .setProducts(order.getItems().stream().map(orderItem ->
                                 com.comrade.kafka.order.avro.model.Product.newBuilder()
    ...
    public PaymentResponse paymentResponseAvroModelToPaymentResponse(PaymentResponseAvroModel
        ...
        return PaymentResponse.builder()
                ...
                .paymentStatus(com.comrade.domain.valueobject.PaymentStatus.valueOf(paymentResponseAvroModel.getPaymentStatus().name()))
    ...
    approvalResponseAvroModelToApprovalResponse(RestaurantApprovalResponseAvroModel
        ...
        return RestaurantApprovalResponse.builder()
                ...
                .orderApprovalStatus(com.comrade.domain.valueobject.OrderApprovalStatus.valueOf(restaurantApprovalResponseAvroModel.getOrderApprovalStatus().name()))
