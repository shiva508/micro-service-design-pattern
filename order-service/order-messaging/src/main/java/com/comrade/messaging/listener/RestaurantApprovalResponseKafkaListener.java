...
import com.comrade.domain.ports.input.message.listener.restaurantapproval.RestaurantApprovalResponseMessageListener;
import com.comrade.kafka.consumer.KafkaConsumer;
import com.comrade.kafka.order.avro.model.OrderApprovalStatus;
import com.comrade.kafka.order.avro.model.RestaurantApprovalResponseAvroModel;
        ...
        messages.forEach(restaurantApprovalResponseAvroModel -> {
            try {
                if (OrderApprovalStatus.APPROVED == restaurantApprovalResponseAvroModel.getOrderApprovalStatus()) {
                    ...
                    log.info("Processing rejected order for order id: {}, with failure messages: {}", restaurantApprovalResponseAvroModel.getOrderId(), String.join(Order.FAILURE_MESSAGE_DELIMITER,restaurantApprovalResponseAvroModel.getFailureMessages()));
